...
const graphemeSegmenter = typeof Intl !== 'undefined' && (Intl as typeof Intl & { Segmenter?: new (locale?: string, options?: { granularity: 'grapheme' }) => { segment: (value: string) => Iterable<{ segment: string }> } }).Segmenter
    ? new ((Intl as typeof Intl & { Segmenter: new (locale?: string, options?: { granularity: 'grapheme' }) => { segment: (value: string) => Iterable<{ segment: string }> } }).Segmenter)(undefined, { granularity: 'grapheme' })
    : null;
