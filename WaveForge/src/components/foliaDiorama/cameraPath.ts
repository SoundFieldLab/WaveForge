...
/**
 * 歌词摆放幅度 —— folia 原值 1.8/1.2/0.2/0.16/1.1。
 * offsetR/U/look 保留 folia 原值（空间构图/三分法偏移，是"舞台化排版"的核心）；
 * 但 roll/yaw 从 0.2/0.16 收敛到 0.09/0.1 —— 用户反馈"不是左斜就是右斜太单一"：
 * 每行 ±11.5° 的种子倾角叠加相机的对齐继承，整个画面退化成左右交替倾斜。
 * 收敛后行仍带轻微舞台倾角（±5°内），但镜头的多样性改由 shot 语言承担。
 */
export const DIORAMA_TEXT_OFFSET_R = 1.8;
export const DIORAMA_TEXT_OFFSET_U = 1.2;
export const DIORAMA_TEXT_ROLL = 0.09;
export const DIORAMA_TEXT_YAW = 0.1;
...
// 鈹€鈹€鈹€ Motion params: tuning + sub-modes -> one scale bundle 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
const DIORAMA_SUB_MODE_PRESETS = {
    // move 上调：shot 语言的位移幅度整体放大，运镜更可感（用户反馈镜头语言单一）
    normal: { move: 1.15, drift: 0.62, smooth: 0.42, audio: 1, weave: 1 },
    calm: { move: 0.72, drift: 0.4, smooth: 0.56, audio: 0.5, weave: 0.5 },
    chaotic: { move: 1.45, drift: 0.85, smooth: 0.33, audio: 1.35, weave: 1.35 },
} as const;
...
// 鈹€鈹€鈹€ Winding path with per-line frames 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€鈹€ Free per-line text placement 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
// 鈹€鈹€鈹€ Shot language: distinct cinematic moves ("杩愰暅鎵嬫硶") 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
const computeShotWeights = (lineIndex: number, lines: Line[], subMode: DioramaSubMode = 'normal'): ShotWeights => {
    ...
    if (isChorus) {
        ...
        // 主歌：降低近似静止的 hold/float 权重，把镜头语言让给真实运镜
        // （crane/pullBack 的垂直纵深 + track/pendulum 的横移），避免"只会左右斜"
        w.track += 1.1;
        w.crane += 1.1;
        w.pendulum += 0.8;
        w.glide += 0.6;
...
export const resolveShotOffset = (kind: DioramaShotKind, ctx: DioramaShotContext): DioramaShotOffset => {
    ...
    switch (kind) {
        ...
        case 'track':
            ...
            right = dir * hero * 0.4 * Math.sin(Math.PI * clamp01(ctx.wordProgress));
            back = hero * 1.06;
            up = lift + 0.12;
            break;
        case 'crane': {
            ...
            const from = dir > 0 ? -1.7 : 2.7;
            const to = dir > 0 ? 2.7 : -1.6;
            up = from + (to - from) * e;
            back = hero * 1.05;
            break;
        }
        case 'swell': {
            ...
            const theta = dir * 0.46 * e;
            right = hero * Math.sin(theta) * 1.1;
            back = hero * (1.0 + 0.38 * e);
            up = lift + 1.35 * e + 0.3;
            break;
        }
        case 'spiral': {
        ...
        case 'pendulum': {
            ...
            right = dir * hero * 0.5 * (2 * e - 1);
            up = lift + 1.0 - 1.0 * Math.sin(Math.PI * e);
            back = hero * 1.02;
            break;
        }
        case 'flyby': {
            ...
            right = dir * hero * (0.8 - 1.6 * e);
            back = hero * (0.76 + 0.12 * Math.sin(Math.PI * e));
            up = lift + 0.05;
            break;
        }
        case 'arc': {
            ...
            const theta = dir * 0.55 * Math.sin(Math.PI * e);
            right = hero * Math.sin(theta) * 1.45;
            back = hero * (1.05 + 0.12 * (1 - Math.cos(theta)));
            up = lift + 0.6 * Math.sin(Math.PI * e);
            break;
        }
        case 'float': {
            ...
            right = dir * hero * 0.18 * Math.sin(e * Math.PI * 2);
            up = lift + 0.7 + 0.6 * Math.sin(e * Math.PI * 2 + 1.0);
        ...
        case 'glide': {
            ...
            right = dir * hero * 0.26 * e;
            up = lift + 1.6 * e;
            back = hero * (1.15 - 0.28 * e);
            break;
        }
        case 'hold':
        default:
...
// 鈹€鈹€鈹€ Procedural geometry 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
