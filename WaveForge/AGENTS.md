...
npm run test             # vitest 单测 (test/ + src/services/waveforge-engine-v3/, 41 文件 477 用例：472 过 + 5 跳过；v3 的 5 项 LGPL 用例未装可选依赖自动跳过)
